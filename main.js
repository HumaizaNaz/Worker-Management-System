...
async function deleteWorker() {
    ...
    collectionOfWorkers = collectionOfWorkers.filter((worker) => worker.workerId !== workerId.workerId);
    console.log("\n");
...
async function updateWorker() {
    ...
    let worker = collectionOfWorkers.find((worker) => worker.workerId === workerId.workerId);
    if (worker) {
